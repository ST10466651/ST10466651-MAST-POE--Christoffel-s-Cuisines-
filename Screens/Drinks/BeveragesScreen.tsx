...
type DrinksScreenNavigationProp = StackNavigationProp<DrinksStackParamList, 'Beverages'>;

export default function BeveragesScreen({ navigation }: { navigation: DrinksScreenNavigationProp }) {
  const { drinks } = useContext(AppDataContext);
  const beverages = drinks.beverages || [];
