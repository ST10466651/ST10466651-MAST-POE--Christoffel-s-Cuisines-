...
type DrinksScreenNavigationProp = StackNavigationProp<DrinksStackParamList, 'Wine'>;

export default function WineScreen({ navigation }: { navigation: DrinksScreenNavigationProp }) {
  const { drinks } = useContext(AppDataContext);
  const wines = drinks.wines || [];
