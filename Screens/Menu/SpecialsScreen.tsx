...
type MenuScreenNavigationProp = StackNavigationProp<MenuStackParamList, 'Specials'>;

export default function SpecialsScreen({ navigation }: { navigation: MenuScreenNavigationProp }) {
  const { food } = useContext(AppDataContext);
  const specials = food.specials || [];
