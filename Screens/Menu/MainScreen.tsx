...
type MenuScreenNavigationProp = StackNavigationProp<MenuStackParamList, 'Main'>;

export default function MainScreen({ navigation }: { navigation: MenuScreenNavigationProp }) {
  const { food } = useContext(AppDataContext);
  const mains = food.mains || [];
